...
const DEFAULT_SLIDES = [
  {
    ...
    accent: ORANGE,
    imgs: [
      "/public/chicken001.jpg",
      "/public/egusi001.jpg",
      "/public/friedrice001.jpg",
      "/public/jpllof001.jpg",
    ],
  },
  {
    headline: "Your Swift Door\nto Everything.",
  ...
  },
  {
    ...
    accent: ORANGE,
    imgs: [
      "/public/icecream001.jpg",
      "/public/icecream002.jpg",
      "/public/choko002.jpg",
      "/public/choco001.jpg",
    ],
  },
...
// ═════════════════════════════════════════════════════════════════════════════
//  FOOTER  — logo image removed, replaced with text only
// ═════════════════════════════════════════════════════════════════════════════
function Footer() {
  const nav = useNavigate();
  return (
...
/* ROOT — padding-top so content never hides under fixed navbar */
.sn-root {
  min-height:100vh;
  background:var(--bg);
  color:var(--txt);
...
@keyframes slideInBottom {
  from { opacity:0; transform: translateY(24px) rotateX(8deg) scale(0.97); }
...
@keyframes logoGlow {
  0%,100% { filter: drop-shadow(0 0 8px rgba(255,107,0,0.5)); }
  50% { filter: drop-shadow(0 0 18px rgba(255,107,0,0.9)); }
}
...
.sn-nav-dropdown {
  ...
  background: linear-gradient(135deg, rgba(14,14,22,0.99), rgba(22,12,4,0.99));
...
@media(min-width: 860px) {
  ...
  .sn-logo-text-desktop em {
    color: var(--acc);
    font-style: italic;
    text-shadow: 0 0 24px rgba(255,107,0,0.5);
  }
}
...
.sn-p0 { width:4px;height:4px; left:15%; bottom:20%; animation-duration:3.5s; }
...
.sn-btn-primary:active { transform:translateY(0); }
...
.sn-kicker {
  ...
  background:rgba(255,107,0,0.09); border:1px solid rgba(255,107,0,0.22);
...
.sn-quote {
  border-left:3px solid var(--acc); padding:14px 16px;
