...
const T = {
  dark: {
    ...
    text: "#e8e8f0",
    textSub: "rgba(232,232,240,0.5)",
    textMuted: "rgba(232,232,240,0.28)",
    headerBg: "rgba(10,10,10,0.93)",
  ...
  light: {
    ...
    text: "#111118",
    textSub: "rgba(17,17,24,0.5)",
    textMuted: "rgba(17,17,24,0.35)",
    headerBg: "rgba(240,240,245,0.93)",
...
export default function RiderDashboard() {
  ...
  const [incomingOrder, setIncomingOrder] = useState<IncomingOrderData | null>(
    null,
  );
  ...
  useEffect(() => {
    ...
    const unsub = onSnapshot(
      doc(db, orderCollection, rider.currentOrderId),
      (snap) => {
        if (!snap.exists()) {
          setIncomingOrder(null);
          setActiveOrder(null);
    ...
    const handleSWMessage = (event: MessageEvent) => {
      if (event.data?.type === "PLAY_NOTIFICATION_SOUND") {
        audio.volume = parseFloat(
          localStorage.getItem("riderAlertVolume") ?? "1.0",
        );
        audio.currentTime = 0;
        audio.play().catch(() => {});
      }
      ...
      >
        ...
        <img
          ...
          style={{
            ...
            height: 60,
            objectFit: "contain",
            filter: `drop-shadow(0 0 16px ${O}88)`,
          }}
        />
        <span
          style={{
    ...
    return (
      ...
      >
        ...
        <div style={{ maxWidth: 400, width: "100%", textAlign: "center" }}>
          ...
          >
            Hey {rider.firstName}! 👋 Your application is being reviewed.
            <br />
            Usually takes{" "}
            <strong style={{ color: tk.text }}>24–48 hours</strong>.
          </p>
    ...
    return (
      ...
      >
        ...
        <div style={{ maxWidth: 400, width: "100%", textAlign: "center" }}>
          ...
          >
            <button
              onClick={() => (window.location.href = "/rider/signup")}
              style={{
                padding: "13px 24px",
                borderRadius: 12,
  ...
  return (
    <div
      style={{
        ...
        background: tk.bg,
        fontFamily: "'Syne',sans-serif",
        paddingBottom: activeOrder ? 200 : 90,
        maxWidth: 480,
        margin: "0 auto",
        transition: "background 0.3s",
      }}
        ...
        <div style={{ animation: "fadeIn 0.3s both" }}>
              ...
              >
                ...
                <button
                  onClick={async () => {
                    ...
                    if (perm === "denied")
                      alert(
                        "Notifications blocked. Go to Chrome Settings → Site Settings → Notifications → allow this site.",
                      );
                  }}
                  style={{
                    background: O,
            ...
            >
              ...
              <span
                style={{
                  width: 1,
                  height: 10,
                  background: tk.cardBorder,
                  margin: "0 2px",
                }}
              />
              <RiMotorbikeLine size={12} />{" "}
          ...
          <div
            ...
            style={{
              ...
              background: rider.isOnline
                ? `linear-gradient(135deg,${O}18,${O}08)`
                : tk.card,
              border: `1px solid ${rider.isOnline ? `${O}33` : tk.cardBorder}`,
              display: "flex",
              alignItems: "center",
              justifyContent: "space-between",
              cursor: "pointer",
          ...
          >
            <div>
              ...
              <div
                style={{
                  fontSize: 17,
                  fontWeight: 900,
                  color: rider.isOnline ? O : tk.text,
                }}
              >
            ...
            <div
              ...
              style={{
                ...
                height: 28,
                borderRadius: 50,
                background: rider.isOnline ? O : tk.cardBorder,
                display: "flex",
                alignItems: "center",
                padding: 3,
                transition: "background 0.3s",
          ...
          >
            {[
              ...
              {
                val:
                  rider.stats.rating > 0 ? rider.stats.rating.toFixed(1) : "—",
                label: "Rating",
                color: rider.stats.rating >= 4 ? "#10B981" : undefined,
              },
          ...
          >
            ...
            >
              ...
              {earnings.today.toLocaleString("en-NG", {
            ...
            >
              {earnings.today === 0
                ...
                : `From ${earnings.orders} delivered order${earnings.orders !== 1 ? "s" : ""}`}
            </div>
            <div style={{ display: "flex", gap: 10, marginTop: 16 }}>
              {[
                ...
                >
                  <div
                    style={{ fontSize: 14, fontWeight: 800, color: tk.text }}
                  >
                    {v}
                  </div>
                  <div
          ...
          >
            {[
              [
                <RiShieldCheckLine size={14} color={O} />,
                "Status",
                <span
                  style={{
                    color: "#10B981",
              ...
              [
                <RiMotorbikeLine size={14} color={O} />,
                "Vehicle",
                VEHICLE_LABELS[rider.vehicleType] || rider.vehicleType,
              ],
              [
                <RiPhoneLine size={14} color={O} />,
                "Phone",
                `+234 ${rider.phone}`,
              ],
              ...
              <div
                ...
                style={{
                  ...
                  padding: "14px 16px",
                  borderBottom:
                    i < arr.length - 1 ? `1px solid ${tk.rowBorder}` : "none",
                  gap: 12,
                }}
              >
                <span
      ...
      {tab === 2 && (
        <div style={{ animation: "fadeIn 0.3s both" }}>
          <div style={{ padding: "24px 20px 8px" }}>
            ...
            >
              Your accepted, rejected and reassigned orders
            </p>
          </div>
          <RiderOrderHistory />
        </div>
...
const STATUS_NEXT: Record<
  ...
  {
    label: string;
    next: "picked_up" | "arriving" | "delivered";
    emoji: string;
  } | null
> = {
  rider_assigned: {
      ...
      <div className="aop-root">
        ...
        >
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            >
              {order.vendorName ?? "Delivery in progress"}
            </div>
            {order.deliveryFee && order.deliveryFee > 0 && (
              ...
              >
                Est. earning: ₦{order.deliveryFee.toLocaleString("en-NG")}
              </div>
            )}
          </div>
        ...
        {showPickupCode && (
          <div className="aop-pickup-code">
            <div>
              ...
              >
                Your Pickup Code — show to vendor
              </div>
              <div
                style={{
                  fontFamily: "'Syne',sans-serif",
        ...
        {isDelivered ? (
          ...
          <>
            ...
            >
              🔐 Ask customer for their delivery code — open navigation to
              verify
            </div>
          ...
          <>
            ...
            >
              {isReady
                ? "✅ Order ready — head to vendor and pick up"
                : "⏳ Vendor is preparing the order — wait nearby"}
            </div>
            <div className="aop-btns">
              <button className="aop-nav-btn" onClick={onNavigate}>
                🗺️ Navigate
              ...
              >
                {loading ? (
                  ...
                  `${next?.emoji ?? "📦"} ${next?.label ?? "Mark Picked Up"}`
                )}
              </button>
            </div>
          </>
